      ...
      case "chat":
        return (
          <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Restaurant Intelligence Chat with Map</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
            ...
            {/* Map and Chat Layout */}
            <div className="h-[calc(100vh-80px)] flex flex-col max-w-full mx-auto px-2 sm:px-3 overflow-hidden">
